...
void addTwoMatrices (double (&mat1)[100][100], double (&mat2)[100][100], double (&sum)[100][100], int m, int n, int t) {
	// Add two matrices
...
//2	
	clock_t t; 
	t = clock();
	addTwoMatrices(mat1,mat2,sum,m,n, 2);
	t = clock()-t;
...
//4
	t = clock();
	addTwoMatrices(mat1,mat2,sum,m,n, 4);
	t = clock()-t;
    printf ("4 Thread Addition took %ld clicks (%f seconds).\n",t,((float)t)/CLOCKS_PER_SEC);

//8
	t = clock();
	addTwoMatrices(mat1,mat2,sum,m,n, 8);
	t = clock()-t;
    printf ("8 Thread Addition took %ld clicks (%f seconds).\n",t,((float)t)/CLOCKS_PER_SEC);

//20
	// t = clock();
	// addTwoMatrices(mat1,mat2,sum,m,n, 20);
	// t = clock()-t;
