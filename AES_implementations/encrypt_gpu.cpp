...
#pragma acc enter data copyin(expandedKey[0:176], paddedMessage[0:paddedMessageLen]) create(encryptedMessage[0:paddedMessageLen])

#pragma acc parallel loop firstprivate(paddedMessageLen) present(paddedMessage[0:paddedMessageLen], expandedKey[0:176], encryptedMessage[0:paddedMessageLen])
	for (int i = 0; i < paddedMessageLen; i += 16) {
		// cout << "HI" << i << endl;
		AESEncrypt(paddedMessage+i, expandedKey, encryptedMessage+i);
	}
#pragma acc exit data copyout(encryptedMessage[0:paddedMessageLen]) delete(expandedKey[0:176], paddedMessage[0:paddedMessageLen])
