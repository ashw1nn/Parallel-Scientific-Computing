...
int main(int argc, char* argv[]) {
	...
	cout << msgstr.size() << endl;
	char * msg = new char[msgstr.size()+1];

	strcpy(msg, msgstr.c_str());
	int n = strlen((const char*)msg) - 1;
...
#pragma omp parallel for num_threads(threads) shared(messageLen, decryptedMessage, encryptedMessage, expandedKey)
