...
int main() {
    ...
    #pragma acc enter data copyin(expandedKey[0:176], encryptedMessage[0:messageLen]) create(decryptedMessage[0:messageLen])

    #pragma acc parallel loop firstprivate(messageLen) present(encryptedMessage[0:messageLen], expandedKey[0:176], decryptedMessage[0:messageLen])
	for (int i = 0; i < messageLen; i += 16) {
		// cout << "HI" << i << endl;
		AESDecrypt(encryptedMessage + i, expandedKey, decryptedMessage + i);
	}
    
    #pragma acc exit data copyout(decryptedMessage[0:messageLen]) delete(expandedKey[0:176], encryptedMessage[0:messageLen], messageLen)	
